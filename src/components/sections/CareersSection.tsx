  ...
  return (
    <section id="careers" className="mt-24">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h2 className="text-3xl font-bold text-slate-900">Careers & Growth</h2>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        {careerHighlights.map(role => (
          <div key={role.title} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md">
            <p className="text-sm uppercase tracking-[0.3em] text-blue-500">Featured role</p>
            ...
            <p className="mt-3 text-sm text-slate-600">{role.perk}</p>
