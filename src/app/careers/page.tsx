...
interface JobListingsSectionProps {
  jobOpenings: typeof jobOpenings;
  additionalJobs: typeof additionalJobs;
}

function JobListingsSection({ jobOpenings, additionalJobs }: JobListingsSectionProps) {
  return (
    <section className="py-16 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
...
export default function CareersPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <AwardsSection />
      <JobListingsSection jobOpenings={jobOpenings} additionalJobs={additionalJobs} />
      <RemoteWorkSection />
    </div>
  );
}
